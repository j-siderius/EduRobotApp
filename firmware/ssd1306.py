...
# Tutorial from https://randomnerdtutorials.com/raspberry-pi-pico-ssd1306-oled-micropython/
...
class DisplayManager:
    def __init__(self, i2c):
        ...
        try:
            ...
            self.display = Blackhole()
            print("Display could not initialise, likely due to I2C problems, created catchall object")
        
    def updateStatus(self, battery_percentage: int = -1, wifi_status: str = "", ip_addr: str = ""):
        self.display.fill(0)
        self.display.text('--- EduRobot ---', 0, 0)
        if battery_percentage < 0:
            self.display.text(f'Battery:N/A', 0, 15)
        else:
            self.display.text(f'Battery:{battery_percentage}%', 0, 15)
            
        if wifi_status == "connected" and ip_addr != "":
            self.display.text('WiFi:Connected', 0, 30)
...
if __name__ == "__main__":
    ...
    if battery_percentage < 0:
        display.text(f'Battery:N/A', 0, 10)
    else:
        display.text(f'Battery:{battery_percentage}%', 0, 10)
        
    if wifi_status == "connected" and wifi_addr != "":
        ...
        display.text('WiFi:Unknown', 0, 20)
